program run_MvsT
    ...
    real*8, allocatable :: Em_ZFC(:, :), Em_FC(:, :), En_ZFC(:, :), En_FC(:, :), Z(:), SH(:), S0(:)
...
!-----------------------------------------------------------------------------------------------------
    ...
    allocate(Em_ZFC(0:2, 0:N-1), Em_FC(0:2, 0:N-1), En_ZFC(0:2, 0:N-1), En_FC(0:2, 0:N-1))
    allocate(Z(0:N-1), SH(0:N-1), S0(0:N-1))
...
!-----------------------------------------------------------------------------------------------------
    ...
    do k2 = 1, 10*X2
        ...
        call evolution(N, Mu, Em_ZFC, En_ZFC, Z, SH, S0, HS_ZFC, HS_ZFC, HK, alp, dt)
        call evolution(N, Mu, Em_FC, En_FC, Z, SH, S0, HS_FC, HS_FC, HK, alp, dt)
    ...
    do k1 = 1, X1
        do k2 = 1, X2
            ...
            call evolution(N, Mu, Em_ZFC, En_ZFC, Z, SH, S0, H, H, HK, alp, dt)
            call evolution(N, Mu, Em_FC, En_FC, Z, SH, S0, H, H, HK, alp, dt)
