...
!-------------------------------------------------------------------------------------------------------------------------------------------  
    ...
    open(103, file='./solvers/llg-t/temporal/Microstates/Saturation.txt', action='write')   
    open(104, file='./solvers/llg-t/temporal/Signals.txt', action='write') 
...
!-------------------------------------------------------------------------------------------------------------------------------------------  
    ...
    do k2 = 1, 10*X2
        call evolution(N, Mu, Em, En, Z, SH, S0, Ha, Ha, HK, alp, dt) ! Evolution
    end do   
    ...
    do k0 = 1, X0
        do k1 = 1, X1
            do k2 = 1, X2
                ...
                t  = t + dt                                                   ! Next Time
                call evolution(N, Mu, Em, En, Z, SH, S0, Ha, Hb, HK, alp, dt) ! Evolution
            end do
            ...
            write(filename, '(A,I2.2,A,I3.3,A)') './solvers/llg-t/temporal/Microstates/', k0, '_', k1, '.txt'
